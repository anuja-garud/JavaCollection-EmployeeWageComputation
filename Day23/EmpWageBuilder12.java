...
public class EmpWageBuilder12 implements EmpWageBulidercmp
{
	
	 
	private List<Company> companies;

	public EmpWageBuilder12() 
	{
		companies = new ArrayList<Company>();    //Array
	}

	public static void main(String[] args) {
	
		final EmpWageBuilder12 empBuilder = new EmpWageBuilder12();
	...
	public void computeEmpWage(){
		...
		{
			final Comapny company  =companies.get(i);
...
class Company {
	...
	{															
		...
		this.maxHrsInMonth = maxHrsInMonth;					//parameterized Constructor
	}
